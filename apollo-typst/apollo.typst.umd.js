(function(global2, factory) {
  ...
  function preloadRemoteFonts(userFonts, options) {
    ...
    if (options && (options == null ? void 0 : options.assets) !== false && ((_a = options == null ? void 0 : options.assets) == null ? void 0 : _a.length) && ((_b = options == null ? void 0 : options.assets) == null ? void 0 : _b.length) > 0) {
  ...
  function withAccessModel(accessModel) {
    return async (_, ctx) => {
      ...
      if (ctx.alreadySetAccessModel) {
        throw new Error(`already set some assess model before: ${(_a = ctx.alreadySetAccessModel.constructor) == null ? void 0 : _a.name}(${ctx.alreadySetAccessModel})`);
      }
  ...
  const gRendererModule = new LazyWasmModule(async (bin) => {
    const module2 = await Promise.resolve().then(() => wasmPackShim);
  ...
  class TypstCompilerDriver {
    ...
    async init(options) {
      ...
      const hasPreloadRemoteFonts = (_a = compilerOptions.beforeBuild) == null ? void 0 : _a.some((fn) => fn._preloadRemoteFontOptions !== void 0);
...
${e.stack}` : e.toString();
  ...
  async function __wbg_init(input) {
    ...
    if (typeof input === "undefined") {
      input = importWasmModule("typst_ts_renderer_bg.wasm", typeof document === "undefined" && typeof location === "undefined" ? require("url").pathToFileURL(__filename).href : typeof document === "undefined" ? location.href : _documentCurrentScript && _documentCurrentScript.src || new URL("apollo.typst.umd.js", document.baseURI).href);
    }
    const imports = __wbg_get_imports();
