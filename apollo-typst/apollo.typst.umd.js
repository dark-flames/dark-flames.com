(function(global2, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory() : typeof define === "function" && define.amd ? define(factory) : (global2 = typeof globalThis !== "undefined" ? globalThis : global2 || self, global2.TypstApollo = factory());
})(this, function() {
...
var __publicField = (obj, key, value) => __defNormalProp(obj, typeof key !== "symbol" ? key + "" : key, value);
  ...
  function _resolveAssets(options) {
    var _a2, _b2;
    const fonts = [];
    if (options && (options == null ? void 0 : options.assets) !== false && ((_a2 = options == null ? void 0 : options.assets) == null ? void 0 : _a2.length) && ((_b2 = options == null ? void 0 : options.assets) == null ? void 0 : _b2.length) > 0) {
      let defaultPrefix = {
  ...
  function withAccessModel(accessModel) {
    return async (_, ctx) => {
      ...
      if (ctx.alreadySetAccessModel) {
        throw new Error(`already set some assess model before: ${(_a2 = ctx.alreadySetAccessModel.constructor) == null ? void 0 : _a2.name}(${ctx.alreadySetAccessModel})`);
      }
      ...
      const wheelEventHandler = (event) => {
        ...
        if (event.ctrlKey) {
          ...
          if (Math.abs(this.currentScaleRatio - 1) < 1e-5) {
            ...
            (_c2 = this.hookedElem.parentElement) == null ? void 0 : _c2.classList.remove("hide-scrollbar-x");
            if (this.previewMode === PreviewMode.Slide) {
  ...
  const gRendererModule = (module2) => new LazyWasmModule(async (bin) => {
  ...
  async function rendererBuildInfo() {
    const renderModule = await Promise.resolve().then(() => wasmPackShim);
  ...
  const gCompilerModule = new LazyWasmModule(async (bin) => {
    const module2 = await Promise.resolve().then(() => typst$1);
    return await module2.default(bin);
  });
  function createTypstCompiler() {
    return new TypstCompilerDriver();
  }
  const _TypstCompilerDriver = class _TypstCompilerDriver {
    constructor() {
      __publicField(this, "compiler");
      __publicField(this, "compilerJs");
    }
    async init(options) {
      this.compilerJs = await Promise.resolve().then(() => typst$1);
      ...
      const hasSpecifiedAssets = beforeBuild.some((fn) => {
        var _a2;
        return ((_a2 = fn._preloadRemoteFontOptions) == null ? void 0 : _a2.assets) !== void 0;
      });
      const hasDisableAssets = beforeBuild.some((fn) => {
        var _a2;
        return ((_a2 = fn._preloadRemoteFontOptions) == null ? void 0 : _a2.assets) === false;
      });
  ...
  let TypstCompilerDriver = _TypstCompilerDriver;
  ...
  const Typst = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
    __proto__: null,
    FetchAccessModel,
    FetchPackageRegistry,
    createTypstCompiler,
  ...
  window.typstBookRenderPage = function(plugin, relPath, appElem) {
    ...
    const typstBindCustomSemantics = async (root, svg, semantics) => {
      const index2 = root == null ? void 0 : root.getAttribute("data-index");
      const key = `${index2}`;
    ...
    async function reloadArtifact(theme) {
      ...
      const artifactData = await fetch(`${relPath}/${theme}/main.multi.sir.in`).then((response) => response.arrayBuffer()).then((buffer) => new Uint8Array(buffer));
...
${val.stack}`;
  ...
  async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === "undefined") {
      module_or_path = importWasmModule("typst_ts_renderer_bg.wasm", typeof document === "undefined" && typeof location === "undefined" ? require("url").pathToFileURL(__filename).href : typeof document === "undefined" ? location.href : _documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === "SCRIPT" && _documentCurrentScript.src || new URL("apollo.typst.umd.js", document.baseURI).href);
    }
    const imports = __wbg_get_imports();
  ...
  const typst = {};
  const typst$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
    __proto__: null,
    default: typst
  }, Symbol.toStringTag, { value: "Module" }));
  return index;
